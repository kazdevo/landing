        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">
              Большинство наших клиентов не понимают своих рабочих процессов.
            </h2>
            <p className="text-xl text-gray-400">
              Дуис ауте ируре долор ин репрехендитур ин волуптате велит ессе
              циллум долоре еу фугиат нулла париатур. Еxцептеур синт оццаецат
              цупидатат.
            </p>
          </div>
